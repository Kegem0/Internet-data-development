...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="styleshee   t" href="bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Sign a new membership</p>
        ...
        <?= $form->field($model, 'college')?>
                ...
                <?= $form->field($model, 'password')->passwordInput() ?>    <div class="row">
